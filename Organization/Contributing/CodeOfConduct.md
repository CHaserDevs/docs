...
これは参加している全員にとって居心地のいい場所にするためのガイドラインです。 参加者の安全性を担保するために、参加者全員が数々のハラスメントについて理解する必要があります。ときに人は無自覚なものです。だからこそ、参加歴の長さにかかわらず、お互いに気をつけなければいけないことがあります。 このガイドラインを心に留め、誰もが楽しく参加できる場にしていきましょう。
...
スポンサーを含むすべての参加者です。また、コミュニケーションツールを使ったやりとりもこれに含まれます。
...
**言動には責任を伴います**：差別、中傷、嫌がらせをしないでください。これには、ジェスチャーやオンラインディスカッション（Twitter、Slackなど）も含まれます。 また、あなたの表示名・アイコン/アバター・背景に映るモノも、あなたに使用責任が伴います。法令と行動規範を遵守するよう注意を払ってください。
...
参加者がハラスメント行為を行った場合、主催者は、加害者の追放を含む、適切とみなされる措置を講じることができます。

あなたがハラスメントを受けている場合、あるいは、誰かがハラスメントを受けていることに気づいた場合、その他の懸念がある場合は、すぐに連絡してください。 後述の連絡先にお願いします。 参加者が施設/会場のセキュリティや関連の法令執行機関に連絡したり、つきそいを行います。または、ハラスメントを経験した人がイベント期間中に安全を感じられるよう対応策を検討し、適切な支援を行います。

イベント主催者またはフォーラム管理者に連絡できない場合や緊急の場合は、警察に電話をしたり、自分自身で状況から離脱してください。

## 連絡先

- [代表: K47de](https://t.me/K47de)
- [副代表: noko1024](https://discordapp.com/users/562308096538705930)

両名には、ハラスメントに関する報告を受け付ける責任があります。 あなたがハラスメントを受けたり、他の人がハラスメントを受けていると思ったり、その他の懸念がある場合は、すぐに連絡してください。